...
<head>
	...
	<meta name="keywords" content="czk,文件目录列表,php" />
	<meta name="description" content="czk在线文件目录列表程序" />
    ...
    <link rel='stylesheet' href='./czkdir/static/css/style.css?v=1002'>
  <!--[if lt IE 9]>
...
<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-white border-bottom" id="navbar">
	<div class="container big-nav">
		...
		<img src="./czkdir/static/images/logo.png" width="180" height="40" class="d-inline-block align-top mr-2" alt="">
		</a>
...
?>
				<li class="nav-item <?php echo $c=='admin'?'active':'';?>">
					<a class="nav-link" href="./?p=admin">后台管理</a>
				</li>
			</ul>
