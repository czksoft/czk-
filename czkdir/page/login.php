...
if($islogin) exit("<script language='javascript'>alert('您已成功登录！');window.location.href='./?p=admin';</script>");
		...
		<div class="row mt-3">
			<div class="col-12 col-sm-11 col-md-9 col-lg-7 col-xl-5 center-block">
				<div class="card border-secondary shadow rounded text-center">
					<div class="card-header">目录后台管理登录</div>
...
<script src="./czkdir/static/js/admin.js"></script>
</body>
</html>