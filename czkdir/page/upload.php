            ...
            <div class="upload-url-wrapper card-tabs-container" id="urlUploader">
                <form id="js-form-url-upload" class="form" onsubmit="return upload_from_url(this);" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" placeholder="离线下载链接" name="url" id="url" required class="form-control" autocomplete="off">
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function upload_from_url(obj){
        ...
        $.ajax({
            type : "POST",
            url : "?p=upload&path=<?php echo urlencode($path);?>",
            data : $(obj).serialize(),
            dataType : 'json',
